...
* Пропуск уже просмотренного видео
...
* Починить конфликт курсора и выбора с клавиатуры/геймпада - когда выглядят выбранными сразу два пункта - под мышиным курсором и просто выбранный с помощью геймпада/стрелок на клавиатуре пункт (передвигать курсор на выбранную кнопку?) ИЛИ добавить в настройки опцию "отключение мышки" (решит и следующую тудушку)
